      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/" element={<Layout />}>
            ...
            />{" "}
            {/* Define the route for the NEET Class 11 program page */}
            <Route
              path="/neet/online-coaching-class-12"
              element={<Class12Program />}
            />{" "}
            {/* Define the route for the NEET Class 12 program page */}
            <Route path="*" element={<ErrorPage />} />{" "}
            {/* Define a wildcard route to handle 404 errors for unknown paths */}
          </Route>
        </Routes>
      </BrowserRouter>
    </div>
